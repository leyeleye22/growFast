...
<head>
    ...
    @php
        $swaggerCdn = 'https://cdn.jsdelivr.net/npm/swagger-ui-dist@5.31.1';
    @endphp
    <link rel="stylesheet" type="text/css" href="{{ $swaggerCdn }}/swagger-ui.css">
    <link rel="icon" type="image/png" href="{{ $swaggerCdn }}/favicon-32x32.png" sizes="32x32"/>
    <link rel="icon" type="image/png" href="{{ $swaggerCdn }}/favicon-16x16.png" sizes="16x16"/>
    <style>
    html
    {
...
<script src="{{ $swaggerCdn }}/swagger-ui-bundle.js"></script>
<script src="{{ $swaggerCdn }}/swagger-ui-standalone-preset.js"></script>
<script>
