...
<body>
    <div class="header"><strong>GrowFast</strong> — Nouvel abonnement</div>
    <div class="content">
        <div class="step">Étape : Abonnement utilisateur</div>
        <p>Un utilisateur s'est abonné à un plan.</p>
        <ul>
            ...
            <li><strong>Expire le :</strong> {{ $userSubscription->expires_at->format('d/m/Y') }}</li>
        </ul>
    </div>
</body>
</html>
